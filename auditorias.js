...
const competencias = [
  ...
  "https://w3.alicante.es/cultura/aula-abierta/",
  "https://play.sporttia.com/center/89",
  "https://www.clicac.es",
  "https://www.eagora.app",
  "https://resasports.com"
];
...
for (const site of competencias) {
  ...
  try {
    ...
    const command = `npx unlighthouse-ci --site ${site} --build-static --output-path ./auditorias-tfg/${folderName}`;

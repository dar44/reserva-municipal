    ...
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-gray-800 p-4 rounded flex flex-col">
          ...
          <Link href="/admin/recintos" className="mt-4 bg-blue-600 hover:bg-blue-700 text-white text-sm py-1 px-2 rounded">Gestionar Recintos</Link>
        </div>
        <div className="bg-gray-800 p-4 rounded flex flex-col">
          ...
          <Link href="/admin/cursos" className="mt-4 bg-blue-600 hover:bg-blue-700 text-white text-sm py-1 px-2 rounded">Gestionar Cursos</Link>
        </div>
        <div className="bg-gray-800 p-4 rounded flex flex-col">
          ...
          <Link href="/admin/usuarios" className="mt-4 bg-blue-600 hover:bg-blue-700 text-white text-sm py-1 px-2 rounded">Gestionar Usuarios</Link>
        </div>
        <div className="bg-gray-800 p-4 rounded flex flex-col">
          ...
          <Link href="/admin/reservas" className="mt-4 bg-blue-600 hover:bg-blue-700 text-white text-sm py-1 px-2 rounded">Ver Reservas</Link>
        </div>
      </div>
    </div>
  )
